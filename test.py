...
if __name__ == "__main__":
    ...
    try:
        ...
        while True:
            ...
            band_buffer1, _ = utils.update_buffer(band_buffer1,
                                                 np.asarray([band_powers1]))
            # Compute the average band powers for all epochs in buffer
            # This helps to smooth out noise
            smooth_band_powers1 = np.mean(band_buffer1, axis=0)
            ...
            alpha_metric = smooth_band_powers1[Band.Alpha] / \
                smooth_band_powers1[Band.Delta]
            print('Alpha Relaxation: ', alpha_metric)

            alpha_metric = smooth_band_powers2[Band.Alpha] / \
